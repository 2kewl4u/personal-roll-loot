...
local lootItemsScrollList = ScrollList.new("PersonalRollLootLootItemScrollFrame", rollTabFrame, 3, "PersonalLootItemButtonTemplate")
...
trialOptionButton.text:SetText("Automatically mark newly added players as 'Trial'")
