...
roleCheckFrame:SetSize(WINDOW_WIDTH / 2, 450)
...
-- item list
itemScrollList = ScrollList.new("PersonalLootRoleCheckItemListScrollFrame", roleCheckFrame, 5, "PersonalLootItemButtonTemplate", true)
itemScrollList:SetPoint("TOP", trialField, "BOTTOM", 0, -(MARGIN + TEXT_FIELD_HEIGHT))
...
itemScrollList:SetFilter(function(index, item, searchText)
    return utils.strContainsIgnoreCase(item:getName(), searchText)
end)
